...
SWIFT_CLASS("_TtC7LuneSDK17LuneConfigWrapper")
@interface LuneConfigWrapper : NSObject <NSCoding>
...
- (nonnull instancetype)initWithBaseUrl:(NSString * _Nonnull)baseUrl token:(NSString * _Nonnull)token customerId:(NSString * _Nonnull)customerId localizationTableName:(NSString * _Nullable)localizationTableName OBJC_DESIGNATED_INITIALIZER;
...
- (UIViewController * _Nonnull)BudgetFormComponent SWIFT_WARN_UNUSED_RESULT;
...
- (UIViewController * _Nonnull)CategoryTrendChartComponentWithStartDate:(NSString * _Nullable)startDate endDate:(NSString * _Nullable)endDate SWIFT_WARN_UNUSED_RESULT;
- (UIViewController * _Nonnull)BrandTrendChartComponentWithStartDate:(NSString * _Nullable)startDate endDate:(NSString * _Nullable)endDate SWIFT_WARN_UNUSED_RESULT;
...
- (void)initializeLoggerWithLogger:(void (^ _Nonnull)(NSDictionary<NSString *, NSString *> * _Nonnull))logger;
